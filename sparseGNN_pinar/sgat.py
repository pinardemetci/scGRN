...
class SGAT(nn.Module):
    def __init__(self,
        ...
        self.denseFinal=Linear(num_hidden, 6)
        self.gat_layers.append(SparseGraphAttentionLayer(
        ...
        print("Checking added layers", self.gat_layers)
    ...
    def forward(self, inputs):
        ...
        # return logits
                #Optional: Gotta play with whether this helps or not -PD:
        h=F.dropout(h, p=0.5, training=self.training)
        logits,_ =self.denseFinal(h)
        logits = logits.mean(1)
        return logits