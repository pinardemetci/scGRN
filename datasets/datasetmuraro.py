...
"""
DATA_FOLDER="/gpfs/data/rsingh47/hzaki1/data-muraro/"
RESOURCES_FOLDER="/gpfs/data/rsingh47/hzaki1/data-muraro/resources"
DATABASE_FOLDER = "/gpfs/data/rsingh47/hzaki1/data-muraro/databases"
...
SC_EXP_FNAME = os.path.join(RESOURCES_FOLDER, "Filtered_Muraro_HumanPancreas_data_renameCols.csv")
REGULONS_FNAME = os.path.join(DATA_FOLDER, "regulons.p")
MOTIFS_FNAME = os.path.join(DATA_FOLDER, "motifs.csv")



class MuraroDataset(Dataset):
    def __init__(self, root, transform=None, pre_transform=None):
        ...
        super(MuraroDataset, self).__init__(root, transform, pre_transform)
