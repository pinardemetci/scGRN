...
"""
DATA_FOLDER="/gpfs/data/rsingh47/hzaki1/data-baron-human/"
RESOURCES_FOLDER="/gpfs/data/rsingh47/hzaki1/data-baron-human/resources"
DATABASE_FOLDER = "/gpfs/data/rsingh47/hzaki1/data-baron-human/databases"
...
class BaronHumanDataset(Dataset):
    def __init__(self, root, transform=None, pre_transform=None):
        ...
        super(BaronHumanDataset, self).__init__(root, transform, pre_transform)
